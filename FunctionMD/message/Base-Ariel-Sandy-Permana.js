...
const MenuList2 = `Hi Kak (≧▽≦), Terimakasih Sudah Memakai Bot Ini Mohon Maaf Jika Masih Ada Beberapa Fitur Yang Error🙏 Silahkan Klick Button Dibawah Untuk Mengakses Bot Ini`
...
⌕ ${prefix}ytsearch <Judul Video/Lagu>
...
if (q.includes('--help')) return reply(examquery) 
    if (args.length < 1) return m.reply(from, `Contoh : ${prefix+order} ${Options.info.ownerName}`, { quoted : m } )
     ...
     console.log(anu5)
    sock.sendMessage(from, { image: { url : anu5 }, caption: `Done`}, { quoted: m } )
...
if (q.includes('--help')) return reply(examquery) 
  ...
  case 'arielsp':{
 {
 	           const arielkece = `*Hii Kak* (≧▽≦)

Silahkan Klick Button Dibawah Untuk Melihat Beberapa Fitur Yang Tersedia`
                let sections = [ { title: `${Options.info.ownerName}`, rows: [ { title: "︻デ═一 All Menu", rowId: "#menu2", description: `Menampilkan Semua Menu ${Options.info.botName}`},{title: "︻デ═一 Group Menu", rowId: "#groupmenu", description: "Menampilkan Menu Group"},{title: "︻デ═一 Download Menu", rowId: "#downloadmenu", description: "Menampilkan Menu Download"},{title: "︻デ═一 Random Video", rowId: "#videomenu", description: `Random Video By ${Options.info.ownerName}`},{title: "︻デ═一 Convert Menu", rowId: "#convertmenu", description: "Menampilkan Menu Convert"},{title: "︻デ═一 RPG Menu", rowId: "#rpgmenu", description: "Menampilkan Menu RPG ⚔️"},{title: "︻デ═一 Textpro Menu", rowId: "#textpromenu", description: "Menampilkan Menu Textpro"},{title: "︻デ═一 Info Menu", rowId: "#infomenu", description: "Menampilkan Menu Informasi"},{title: "︻デ═一 Google Menu", rowId: "#googlemenu", description: "Menampilkan Menu Google"},{title: "︻デ═一 Fun Menu", rowId: "#funmenu", description: "Menampilkan Menu Fun & Enjoy"},{title: "︻デ═一 Random Menu", rowId: "#randommenu", description: "Menampilkan Menu Random"},{title: "︻デ═一 Sound Menu", rowId: "#soundmenu", description: "Menampilkan Menu Musik"},{title: "︻デ═一 Kisah Menu", rowId: "#kisahmenu", description: "Menampilkan Menu Kisah Nabi"},{title: "︻デ═一 Anime Menu", rowId: "#animemenu", description: "Menampilkan Menu Wibu"},{title: "︻デ═一 Tools Menu", rowId: "#toolsmenu", description: "Menampilkan Menu Tools"},{title: "︻デ═一 MTK Menu", rowId: "#mtkmenu", description: "Menampilkan Menu MTK"},{title: "︻デ═一 Game Menu", rowId: "#gamemenu", description: "Menampilkan Menu Game"},{title: "︻デ═一 Top Up Game", rowId: "#topup", description: "Anda Ingin Top Up?"},{title: "︻デ═一 Virtex Menu", rowId: "#virtexmenu", description: `Anda Ingin War? Yuk Cobain Virtex ${Options.info.botName}`},{title: "︻デ═一 WA Imun Menu", rowId: "#wamenu", description: "WhatsApp Anti Virtex"},{title: "︻デ═一 Script Bot Gratis", rowId: "#scbotvip", description: "Script Ori Bot"}, ]}    ]
...
break
  case 'downloadmenu':{
  	const downloadbg = `✘ *D O W N L O A D - M E N U*
...
break
case 'scbotvip':{
const aoakwokwo = `Silahkan Chat Owner : wa.me/6282118022072`
reply(aoakwokwo)
}
break
case 'convertmenu':{
  	const arielsp1 = `✘ *C O N V E R T - M E N U*
...
case 'rpgmenu':{
    {
            ...
            break
case 'textpromenu':{
  	const arielsp3 = `✘ *T E X T P R O - M E N U*
...
break
case 'randommenu':{
	const arielsp2 = `✘ *R A N D O M - M E N U*
...
break
case 'funmenu':{
	const arielspppp = `✘*F U N - M E N U*
...
case 'inikuis':{
	{
                let sections = [ { title: `${Options.info.ownerName}`, rows: [ { title: "Kuis Math Gampang", rowId: "#kuismath noob", description: "Ez"},{title: "Kuis Match Sedang", rowId: "#kuismath easy", description: "Ea"},{title: "Kuis Math Medium", rowId: "#kuismath medium", description: "Lumayan Broh"},{title: "Kuis Math Hard", rowId: "#kuismath hard", description: "Hm"},{title: "Kuis Math Extreme", rowId: "#kuismath extreme", description: "extreme"},{title: "Kuis Math Deathzone", rowId: "#kuismath deathzone", description: "Males Kasih Judul"}, ]}    ]
